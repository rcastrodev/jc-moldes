			...
			<aside class="col-sm-12 col-md-3">
                ...
                <ul class="p-0" style="list-style: none;">
                    @foreach ($categorias as $c)
                        <li class="py-2"> 
                            <a href="{{ route('categoria', ['id'=> $c->id]) }}" class="d-block p-2 text-decoration-none  text-decoration-none font-size-16 position-relative @if($c->id == $categoria->id) text-red @else text-dark @endif"
