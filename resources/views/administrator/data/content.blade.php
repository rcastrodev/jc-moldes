...
<div class="card card-primary">
    ...
    <form action="{{ route('data.content.update') }}" method="post" enctype="multipart/form-data">
        ...
        <div class="card-body">
            ...
            <div class="form-group">
                <input type="text" name="pinterest" value="{{$data->pinterest}}" class="form-control" placeholder="Link del canal de pinterest">
            </div>
            
            <div class="form-group d-flex flex-column">
                <label for="" class="mb-2">Mostrar novedades</label>
                <input type="checkbox" name="news" value="1" @if($data->news) {{ 'checked' }} @endif>
            </div>
            <div class="form-group">
